...
export const brandMessageReplyTemplates: MessageCenterReplyTemplate[] = [
  {
    label: '安排跟进',
...
export const brandMessages: MessageCenterItem[] = [
  {
    id: 'brand-msg-user',
    title: '学员咨询课程适配',
    ...
    followUpAt: '今日 16:00',
    relatedRecords: [
      { label: '学员档案', value: '张敏', href: '/users', kind: '学员' },
      { label: '训练记录', value: '近两周训练', href: '/trainings', kind: '记录' },
    ],
    slaLabel: '今日内',
  ...
  },
  {
    ...
    followUpAt: '',
    relatedRecords: [
      { label: '课程资料', value: '核心稳定进阶', href: '/courses', kind: '课程' },
    ],
    slaLabel: '2 个工作日',
  ...
  },
  {
    ...
    followUpAt: '今日 18:00',
    relatedRecords: [
      { label: '训练记录', value: '近 7 天活跃学员', href: '/trainings', kind: '记录' },
      { label: '学员列表', value: '缺失训练记录人群', href: '/users', kind: '学员' },
    ],
    slaLabel: '今日内',
  ...
  },
  {
    ...
    followUpAt: '',
    relatedRecords: [
      { label: '品牌看板', value: '资料同步状态', href: '/dashboard', kind: '系统' },
    ],
    slaLabel: '无需处理',
...
export const brandMessageSummary = getMessageCenterSummary(brandMessages)

export const brandMessageMetrics: MessageCenterMetric[] = [
  {
    label: '未读消息',
    value: String(brandMessageSummary.unread),
    detail: '来自学员、课程和系统提醒',
  },
  {
    label: '待回复',
    value: String(brandMessageSummary.active),
    detail: '建议在当日运营时段内处理',
  },
  {
    label: '已闭环',
    value: String(brandMessageSummary.resolved),
    detail: '当前示例队列中的闭环消息',
  },
]

export const brandMessagePreview = getMessageCenterPreview(brandMessages)
